...
public class Indus {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> INDUS_TAB =
            CREATIVE_MODE_TABS.register("tab", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(new ItemStack(IndusItems.MAINTENANCE_DEPOT.get()));
    ...
    private void registerPayloads(RegisterPayloadHandlersEvent event) {
        ...
        RequestNetworkSampleMessage.register(registrar);
        ReceiveNetworkSampleMessage.register(registrar);
    }
